...
function BlockchainInfraconsulting() {
  return (
    <>
      <Typography component="div" className="title__section">
        <Typography variant="h1">Blockchain Infra Consulting</Typography>
      </Typography>
      <Typography component="div" className="container">
        <Typography component="div" className="story__content">
          <Typography variant="h3">Blockchain Infra Consulting</Typography>
          <p>
...
export default BlockchainInfraconsulting;
