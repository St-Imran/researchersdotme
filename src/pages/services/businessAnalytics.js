                ...
                <div className="card-img-overlay d-flex flex-column">
                  <div className="card-body">
                    ...
                    <h4 className="card-title mt-0 ">
                      <Link
                        className="text-dark"
                        href="/services/innerPages/productAnalysis"
                      >
                        Product Analysis
                      </Link>
                    </h4>
                  ...
                  <div className="card-footer">
                    <div className="media">
                      ...
                      >
                        ...
                        <small className="text-dark">Product Analysis</small>
                      </Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="card-img-overlay d-flex flex-column">
                  <div className="card-body">
                    ...
                    <h4 className="card-title mt-0 ">
                      <Link
                        className="text-dark"
                        href="/services/innerPages/processAnalysis"
                      >
                        Process Analysis
                      </Link>
                    </h4>
                  ...
                  <div className="card-footer">
                    <div className="media">
                      ...
                      >
                        ...
                        <small className="text-dark">Process Analysis</small>
                      </Link>
                    </div>
                  </div>
                </div>
