...
function OnChainEcosystemConsulting() {
  return (
    <>
      <Typography component="div" className="title__section">
        <Typography variant="h1">On-Chain Ecosystem Consulting</Typography>
      </Typography>
      <Typography component="div" className="container">
        <Typography component="div" className="story__content">
          <Typography variant="h3">On-Chain Ecosystem Consulting</Typography>
          <p>
...
export default OnChainEcosystemConsulting;
