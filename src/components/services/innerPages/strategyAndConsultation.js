...
function StrategyAndConsultation() {
  return (
    <>
      <Typography component="div" className="title__section">
        <Typography variant="h1">Strategy And Consultation</Typography>
      </Typography>
      <Typography component="div" className="container">
        <Typography component="div" className="story__content">
          <Typography variant="h3">Strategy And Consultation</Typography>
          <p>
...
export default StrategyAndConsultation;
